...
add_action( 'init', 'asufse_register_fundingsource', 0 );
function asufse_register_fundingsource() {

	$labels = array(
		'name'                       => _x( 'Sources', 'Taxonomy General Name', 'text_domain' ),
		'singular_name'              => _x( 'Source', 'Taxonomy Singular Name', 'text_domain' ),
		'menu_name'                  => __( 'Funding Sources', 'text_domain' ),
		...
		'not_found'                  => __( 'Not Found', 'text_domain' ),
		'no_terms'                   => __( 'No sources', 'text_domain' ),
	...
	register_taxonomy( 'funding-source', array( 'research' ), $args );
