jQuery(document).ready(function($) {
	...
	$(".menu-item-has-children > a").click(function() {
		if (
			$(this)
				.siblings(".pure-menu-children")
				.is(":hidden")
		) {
			allPanels.slideUp(100);
			allPanels
				.parent()
				.removeClass("pure-menu-expanded")
				.addClass("pure-menu-collapsed");
			$(this)
				.siblings(".pure-menu-children")
				.slideDown(100);
			$(this)
				.parent()
				.removeClass("pure-menu-collapsed")
				.addClass("pure-menu-expanded");
		} else {
			$(this)
				.siblings(".pure-menu-children")
				.slideUp(100);
	...
	$(".hamburger").on("click", function() {
		...
		$("#content").toggleClass("dimmed");

		if ($(this).hasClass("is-active")) {
			$(this).attr("href", "#masthead");
		} else {
			$(this).attr("href", "#");
		}
	});

	$("a.toggle.close").on("click", function() {
		$("#content").toggleClass("dimmed");
